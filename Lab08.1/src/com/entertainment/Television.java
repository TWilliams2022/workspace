...
public class Television {
    ...
    //#1 INSTRUCTION -- add a field in the Television to hold a reference to a turner object
    private Tuner tuner = new Tuner(); // instantiated internally -- ***now delegated***
    ...
    //INSTRUCTION -- #2 add two methods to television
